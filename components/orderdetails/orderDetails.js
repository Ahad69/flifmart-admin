...
const Details = ({ data, reload, setReload }) => {
  const { myCount, setMyCount, setMyOrders } = useContext(MyContext);

  const handleProcced = (id) => {
    Swal.fire({
      title: "Are you sure?",
        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data.status == "success") {
              Swal.fire("Procced!", "Your file has been procced.", "success");
            }
        ...
        <div className={style.userDetails}>
          ...
          {data?.status != "pending" ? (
            ...
            <>
              {" "}
              <button
                onClick={() => handleProcced(data?._id)}
